# X3D CCD Inspector — Improvement Roadmap
...
public class ProcessEventWatcher : IDisposable
{
    ...
    public void Start()
    {
        _session = new TraceEventSession("X3DCcdInspector-ProcessWatch");
...
public static class UpdateChecker
{
    ...
    public static async Task<string?> CheckForUpdate(string currentVersion)
    {
        ...
        Http.DefaultRequestHeaders.UserAgent.ParseAdd("X3DCcdInspector/" + currentVersion);
...
| Feature | Process Lasso | X3D CCD Inspector | Gap Impact |
|---------|--------------|-------------------|------------|
